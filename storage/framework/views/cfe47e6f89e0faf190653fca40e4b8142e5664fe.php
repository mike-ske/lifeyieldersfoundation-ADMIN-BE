    ...
    <main class="h-full overflow-y-auto">
        <div class="container px-6 mx-auto grid">
            ...
            <div class="w-full overflow-hidden rounded-lg shadow-xs mb-4">
                <div class="w-full overflow-x-auto">
                    <table class="w-full whitespace-no-wrap">
                        ...
                        <tbody class="bg-white divide-y dark:divide-gray-700 dark:bg-gray-800">
                            <?php if($application): ?>
                                <?php $__currentLoopData = $application; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $appValue): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                    <tr class="text-gray-700 dark:text-gray-400">
                                        <td class="px-4 py-3">
                                            <div class="flex items-center text-sm">
                                                ...
                                                <div>
                                                    <p class="font-semibold"><?php echo e(Str::upper($appValue->requesting_officer)); ?></p>
                                        ...
                                        <td class="px-4 py-3 text-sm">
                                            <?php echo e(Str::upper($appValue->machine_model)); ?>

                                        </td>
                                        <td class="px-4 py-3 text-sm">
                                            <?php echo e(Str::upper($appValue->department)); ?>

                                        </td>
                                        <td class="font-bold px-4 py-3 text-sm">
                                            <?php echo e(Str::upper($appValue->workdone_by)); ?>

                                        </td>
                                        <td class="px-4 py-3 text-xs">
                                                <?php if($appValue->workdone  === 'Not yet fixed' || $appValue->workdone  === 'not yet fixed'): ?>
                                                    <span
                                                        class="px-2 py-1 font-semibold leading-tight text-red-700 bg-red-100 rounded-full dark:bg-red-700 dark:text-red-100">
                                                        Awaiting
                                                    </span>
                                                <?php endif; ?>
                                                <?php if($appValue->workdone   === 'Pending'): ?>
                                                    <span
                                                ...
                                                <?php endif; ?>
                                                <?php if($appValue->workdone  === 'Fixed' || $appValue->workdone   === 'fixed'): ?>
                                                    <span
                                        ...
                                        <td class="px-4 py-3 text-sm">
                                            <?php echo e(Carbon\Carbon::parse($appValue->created_at)->diffForHumans()); ?>

                                        </td>
                                        <td class="px-4 py-3">
                                            <div class="flex items-center space-x-4 text-sm">
                                                <a href="application/<?php echo e($appValue->id); ?>"
                                                ...
                                                <?php if($role === 'superadmin'): ?>
                                                    <button id="appbtn" type="button" value="<?php echo e($appValue->id); ?>" data-modal-toggle="delete-modal" onclick="return appDelete(this)"
                ...
                <div
                    class="flex w-full px-4 py-3 text-xs font-semibold tracking-wide text-gray-500 uppercase border-t dark:border-gray-700 bg-gray-50  dark:text-gray-400 dark:bg-gray-800">
                    <!-- Pagination -->
                    <div class="flex justify-end mt-2 w-full sm:mt-auto ">
                        <?php echo e($application->links()); ?>
...
<?php echo $__env->make('master.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\Users\Micah\OneDrive\Desktop\FN\faan_admin\resources\views/pages/application.blade.php ENDPATH**/ ?>