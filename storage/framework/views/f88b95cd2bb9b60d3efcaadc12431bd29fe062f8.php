                        ...
                        <div class="w-full sm:w-2/6 p-4 bg-white rounded-lg shadow-xs dark:bg-gray-800 mr-10"
                            ...
                            <div class="relative w-full mr-3 rounded-full md:block">
                                <img class="object-cover rounded-full mx-auto mb-8" style="height: 100px;width:100px"
                                    src="https://ui-avatars.com/api/?name=<?php echo e($students->fname); ?>+<?php echo e($students->lname); ?>"
                                    alt="" loading="lazy">
                                <div class="absolute inset-0 rounded-full shadow-inner" aria-hidden="true">
                                </div>
                            </div>
                            <p class="font-semibold text-center text-gray-600 dark:text-gray-400">
                                <?php echo e($students->fname); ?> <?php echo e($students->lname); ?>
                    ...
                    <?php $__currentLoopData = $student; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $students): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                        <div class="px-4 py-3 mb-8 sm:w-full  rounded-lg shadow-md">
                            ...
                            <div class="grid sm:flex sm:justify-between sm:items-center gap-4 mb-4">
                                ...
                                <a href="#" target="_blank" data-url="<?php echo e($students->certificate); ?>"
                            ...
                            <hr class="mt-8 mb-4">
                            <form action="/pending/<?php echo e($students->id); ?>" method="post" class="mt-7">
                                <?php echo csrf_field(); ?>
                                <?php echo method_field('PATCH'); ?>

                                <input type="hidden" name="user_id" value="<?php echo e($students->user_id); ?>">
...
unset($__errorArgs, $__bag); ?>
                            ...
                            <form action="/pending/<?php echo e($students->id); ?>" method="post">
                                <?php echo csrf_field(); ?>
                                <?php echo method_field('PATCH'); ?>

                                <input type="hidden" name="pendinguser" value="<?php echo e($students->id); ?>">
                                <input type="hidden" name="userId" value="<?php echo e($students->user_id); ?>">
                        ...
                        <div class="w-full sm:w-1/2 p-4 sm:h-1/6 bg-white rounded-lg shadow-xs dark:bg-gray-800 ml-10">
                            <div class="relative w-full mr-3 rounded-full md:block">
                                ...
                                <form action="/pending/<?php echo e($students->id); ?>" method="post" class="mt-7">
                                    <?php echo csrf_field(); ?>
                                    <?php echo method_field('PATCH'); ?>
                                    <input type="hidden" name="appId" value="<?php echo e($students->id); ?>">
                                    <input type="hidden" name="studentId" value="<?php echo e($students->user_id); ?>">
...
unset($__errorArgs, $__bag); ?>
                            ...
                            <?php if($bank): ?>
                                <?php $__currentLoopData = $bank; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $bankdetails): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                    <div class="relative w-full mr-3 pt-20 rounded-full md:block">
                                        ...
                                        <label class="block text-sm mb-4">
                                            ...
                                            <p
                                                class="block w-full mt-1 text-sm dark:border-gray-600 dark:bg-gray-700 focus:border-purple-400 focus:outline-none focus:shadow-outline-purple dark:text-gray-300 dark:focus:shadow-outline-gray form-input">
                                                <?php echo e($bankdetails->address); ?>
                                        ...
                                        <label class="block text-sm mb-4">
                                            ...
                                            <p
                                                class="block w-full mt-1 text-sm dark:border-gray-600 dark:bg-gray-700 focus:border-purple-400 focus:outline-none focus:shadow-outline-purple dark:text-gray-300 dark:focus:shadow-outline-gray form-input">
                                                <?php echo e($bankdetails->country); ?>
                                        ...
                                        <label class="block text-sm mb-4">
                                            ...
                                            <p
                                                class="block w-full mt-1 text-sm dark:border-gray-600 dark:bg-gray-700 focus:border-purple-400 focus:outline-none focus:shadow-outline-purple dark:text-gray-300 dark:focus:shadow-outline-gray form-input">
                                                <?php echo e($bankdetails->bankname); ?>
                                        ...
                                        <label class="block text-sm mb-4">
                                            ...
                                            <p
                                                class="block w-full mt-1 text-sm dark:border-gray-600 dark:bg-gray-700 focus:border-purple-400 focus:outline-none focus:shadow-outline-purple dark:text-gray-300 dark:focus:shadow-outline-gray form-input">
                                                <?php echo e($bankdetails->bankadress); ?>
                                        ...
                                        <label class="block text-sm mb-4">
                                            ...
                                            <p
                                                class="block w-full mt-1 text-sm dark:border-gray-600 dark:bg-gray-700 focus:border-purple-400 focus:outline-none focus:shadow-outline-purple dark:text-gray-300 dark:focus:shadow-outline-gray form-input">
                                                <?php echo e($bankdetails->acctnumber); ?>
                                        ...
                                        <label class="block text-sm mb-4">
                                            ...
                                            <p
                                                class="block w-full mt-1 text-sm dark:border-gray-600 dark:bg-gray-700 focus:border-purple-400 focus:outline-none focus:shadow-outline-purple dark:text-gray-300 dark:focus:shadow-outline-gray form-input">
                                                <?php echo e($bankdetails->acctType); ?>
                                        ...
                                        <label class="block text-sm mb-4">
                                            ...
                                            <p
                                                class="block w-full mt-1 text-sm dark:border-gray-600 dark:bg-gray-700 focus:border-purple-400 focus:outline-none focus:shadow-outline-purple dark:text-gray-300 dark:focus:shadow-outline-gray form-input">
                                                <?php echo e($bankdetails->routenumber); ?>
                                        ...
                                        <label class="block text-sm mb-4">
                                            ...
                                            <p
                                                class="block w-full mt-1 text-sm dark:border-gray-600 dark:bg-gray-700 focus:border-purple-400 focus:outline-none focus:shadow-outline-purple dark:text-gray-300 dark:focus:shadow-outline-gray form-input">
                                                <?php echo e($bankdetails->bankcode); ?>
                                        ...
                                        <form action="/pending/<?php echo e($students->id); ?>" method="post">
                                            ...
                                            <input type="hidden" name="pendinguser" value="<?php echo e($bankdetails->id); ?>">
                                            <input type="hidden" name="bankId" value="<?php echo e($bankdetails->user_id); ?>">
                                            <div class="flex mt-10 text-sm items-right justify-end">
                                                <label class="flex dark:text-gray-400 mb-8">
                                                    <div>
                            ...
                            <?php else: ?>
                                <h1
                                    ...
                                    There are no bank infromation for <br> <?php echo e($bankdetails->fname); ?>
...
<?php echo $__env->make('master.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\Users\Micah\OneDrive\Desktop\FN\faan_admin\resources\views\backend\pendingApp.blade.php ENDPATH**/ ?>