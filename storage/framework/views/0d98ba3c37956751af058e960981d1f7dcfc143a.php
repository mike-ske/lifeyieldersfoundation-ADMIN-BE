...
<div class="hidden overflow-y-auto overflow-x-hidden fixed right-0 left-0 top-4 z-50 justify-center items-center md:inset-0 h-modal sm:h-full"
    id="popup-modal2" aria-hidden="true">
    <div class="w-2/3 mx-auto max-w-1/2 relative px-4 h-full md:h-auto">

        <div id="sliderbox" class="relative bg-white rounded-lg shadow dark:bg-gray-700">
            ...
            <div class="p-6 pt-0 text-left flex items-center gap-8 justify-between w-full">
                <h3 id="alert" class=" w-1/2 mb-5 text-lg font-normal text-gray-200 dark:text-gray-200">
                    Search For Device
                </h3>
                <input style="width: 70%" id="search" onkeyup="return search(this)" type="text" placeholder="Search for device" 
                    class=" w-2/4 pl-8 pr-2 text-sm text-gray-700 placeholder-gray-600 bg-gray-100 border-0 rounded-md dark:placeholder-gray-500 dark:focus:shadow-outline-gray dark:focus:placeholder-gray-400 dark:bg-gray-400 dark:text-gray-800 focus:placeholder-gray-500 focus:bg-white focus:border-purple-300 focus:outline-none focus:shadow-outline-purple form-input">                
       
            </div>


            <div class="w-full flex text-left ">
                <div id="deviceresult" class="p-6 pt-0 text-left "></div>
            </div>
        </div>
    </div>
</div><?php /**PATH C:\Users\Micah\OneDrive\Desktop\FN\faan_admin\resources\views/pages/modal.blade.php ENDPATH**/ ?>