                                    ...
                                    <div class="relative hidden w-8 h-8 mr-3 rounded-full md:block">
                                        ...
                                        <?php $__currentLoopData = $users; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $user): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                            <img class="object-cover w-full h-full rounded-full"
                                                src="https://ui-avatars.com/api/?name=<?php echo e($user->fname); ?>+<?php echo e($user->lname); ?>"
                                                alt="" loading="lazy">
                                ...
                                <div class="max-w-full px-4 py-3 mb-8  rounded-lg shadow-md ">
                                    <div class="flex justify-between items-center py-3 text-sm mb-10">
                                        <h1 class="text-gray-600 font-bold dark:text-gray-400 text-2xl">
                                            <?php echo e($email->mail_subject); ?>

                                        </h1>
                                        <p class="text-gray-600 dark:text-gray-400"><?php echo e($email->created_at->diffForHumans()); ?></p>
                                    </div>
                                    <p class="mb-4 text-gray-600 dark:text-gray-400">
                                        <?php echo e($email->mail_body); ?>
...
<?php echo $__env->make('master.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\Users\Micah\OneDrive\Desktop\FN\faan_admin\resources\views\backend\mailAdmin.blade.php ENDPATH**/ ?>