                                    ...
                                    <tr class="text-gray-700 dark:text-gray-400">
                                        <td class="px-4 py-3">
                                            <div class="flex items-center text-sm">
                                                ...
                                                <?php if($admins): ?>
                                                    <div class="relative w-8 h-8 mr-3 rounded-full md:block">
                                                        <img class="object-cover w-full h-full rounded-full"
                                                            src="https://ui-avatars.com/api/?name=<?php echo e($admins->first_name); ?>+<?php echo e($admins->last_name); ?>"
                                                            alt="" loading="lazy">
                                                ...
                                                <div>
                                                    <p class="font-semibold"><?php echo e($admins->first_name); ?>

                                                        <?php echo e($admins->last_name); ?></p>
                                        ...
                                        <td class="px-4 py-3 text-sm">
                                            <?php echo e($admins->email); ?>

                                        </td>
                                        <td class="px-4 py-3 text-sm">
                                            <?php echo e($admins->created_at->diffForHumans()); ?>

                                        </td>
                                        <td class="px-4 py-3">
                                            <div class="flex items-center space-x-4 text-sm">
                                                <a href="/profile/<?php echo e($admins->id); ?>"
                                                ...
                                                <?php if($role === 'superadmin'): ?>
                                                    <button value="<?php echo e($admins->id); ?>" onclick="return adminDelete(this)"  data-modal-toggle="deleteadmin-modal"
...
<?php echo $__env->make('master.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\Users\Micah\OneDrive\Desktop\FN\faan_admin\resources\views\pages\profile.blade.php ENDPATH**/ ?>