...
<?php $__env->startSection('contents'); ?>
    ...
    <main class="h-full overflow-y-auto">
        <div class="container px-6 mx-auto grid">
            ...
            <!-- Modal body -->
            <div class="mt-4 mb-6">
                <form action="<?php echo e(route('email.store')); ?>" id="mailStudent" enctype="multipart/form-data"
                    class="mt-10">
                    <?php echo csrf_field(); ?>
...
<?php echo $__env->make('master.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\Users\Micah\OneDrive\Desktop\FN\faan_admin\resources\views\backend\sendMail.blade.php ENDPATH**/ ?>