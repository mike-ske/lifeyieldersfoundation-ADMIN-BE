<?php $__env->startSection('contents'); ?>
                ...
                <div class="w-full overflow-x-auto">
                    <table class="w-full whitespace-no-wrap">
                        ...
                        <tbody class="bg-white divide-y dark:divide-gray-700 dark:bg-gray-800">
                            <?php if($student): ?>
                                <?php $__currentLoopData = $student; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $studentValue): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                    <tr class="text-gray-700 dark:text-gray-400">
                                        <td class="px-4 py-3">
                                            <div class="flex items-center text-sm">
                                                ...
                                                <?php else: ?>
                                                    <div class="relative w-8 h-8 mr-3 rounded-full md:block">
                                                        <img class="object-cover w-full h-full rounded-full"
                                                            src="data:image/jpeg;base64,<?php echo e($studentValue->image); ?>" alt=""
                                                            loading="lazy">
                                                        <div class="absolute inset-0 rounded-full shadow-inner"
                                                            aria-hidden="true">
                                                        </div>
                                        ...
                                        <td class="px-4 py-3 text-sm">
                                            <?php echo e($studentValue->programme); ?>
                                        ...
                                        <td class="px-4 py-3">
                                            <div class="flex items-center space-x-4 text-sm">
                                                <a href="students/<?php echo e($studentValue->id); ?>"
                                                ...
                                                <?php if($role === 'superadmin'): ?>
                                                    <button value="<?php echo e($studentValue->id); ?>" onclick="return studentDelete(this)" data-modal-toggle="deletestudent-modal"
                            ...
                            <?php else: ?>
                                <h1>No student account</h1>
                            <?php endif; ?>
                        </tbody>
                    </table>
                </div>
                <div
                    class="grid px-4 py-3 text-xs font-semibold tracking-wide text-gray-500 uppercase border-t dark:border-gray-700 bg-gray-50 sm:grid-cols-2 dark:text-gray-400 dark:bg-gray-800">
                    <!-- Pagination -->
    ...
    <div class="hidden overflow-y-auto overflow-x-hidden fixed right-0 left-0 top-4 z-50 justify-center items-center md:inset-0 h-modal sm:h-full"
        id="deletestudent-modal" aria-hidden="true">
            ...
            <div class="relative bg-white rounded-lg shadow dark:bg-gray-700">
                ...
                <div class="flex justify-end p-2">
                    <button type="button"
                        ...
                        data-modal-toggle="deletestudent-modal">
                ...
                <div class="p-6 pt-0 text-center">
                    <form action="students/delete" method="post" enctype="multipart/form-data">
                        ...
                        <h3 class="mb-5 text-lg font-normal text-gray-500 dark:text-gray-400">Are you sure you want to
                            delete
                            this STUDENT ?</h3>
                        <button data-modal-toggle="deletestudent-modal" type="submit"
                        ...
                        <button data-modal-toggle="deletestudent-modal" type="button"
...
<?php echo $__env->make('master.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\Users\Micah\OneDrive\Desktop\FN\faan_admin\resources\views\pages\student.blade.php ENDPATH**/ ?>