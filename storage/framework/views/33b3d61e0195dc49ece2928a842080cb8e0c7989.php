                    ...
                    <?php $__currentLoopData = $student; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $students): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                        <div class="w-full sm:w-2/6 p-4 bg-white rounded-lg shadow-xs dark:bg-gray-800 mr-10"
                            ...
                            <p class="font-semibold text-center text-gray-600 dark:text-gray-400">
                                <?php echo e($students->requesting_officer); ?>

                            </p>
                            <p class="text-xs text-gray-600 dark:text-gray-400 text-center">
                                <?php echo e(Str::upper($students->department)); ?>
                    ...
                    <?php $__currentLoopData = $student; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $students): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                        <div class="px-4 py-3 mb-8 sm:w-full  rounded-lg shadow-md">
                            ...
                            <div class="w-full flex justify-between items-center">
                                ...
                                <?php if($students->workdone === 'Not yet fixed' || $students->workdone === 'not yet fixed' ): ?>
                                ...
                                <?php endif; ?>
                                <?php if($students->workdone === 'Pending'): ?>
                                    <span style="font-size:10px"
                                ...
                                <?php endif; ?>
                                <?php if($students->workdone === 'Fixed' || $students->workdone   === 'fixed'): ?>
                                    <span style="font-size:10px"
                            ...
                            <label class="block text-sm mb-4">
                                ...
                                <p
                                    ...
                                    <?php echo e(Str::upper($students->machine_model)); ?>
                            ...
                            <label class="block text-sm mb-4">
                                ...
                                <p
                                    class="block w-full mt-1 text-sm dark:border-gray-600 dark:bg-gray-700 focus:border-purple-400 focus:outline-none focus:shadow-outline-purple dark:text-gray-300 dark:focus:shadow-outline-gray form-input">
                                    <?php echo e(Str::upper($students->nature_of_fault)); ?>
                            ...
                            <label class="block text-sm mb-4">
                                ...
                                <p
                                    class="block w-full mt-1 text-sm dark:border-gray-600 dark:bg-gray-700 focus:border-purple-400 focus:outline-none focus:shadow-outline-purple dark:text-gray-300 dark:focus:shadow-outline-gray form-input">
                                    <?php echo e(Carbon\Carbon::parse($students->date_in)->toString()); ?>
                            ...
                            <label class="block text-sm mb-4">
                                ...
                                <p
                                    class="block w-full mt-1 text-sm dark:border-gray-600 dark:bg-gray-700 focus:border-purple-400 focus:outline-none focus:shadow-outline-purple dark:text-gray-300 dark:focus:shadow-outline-gray form-input">
                                    <?php echo e(Carbon\Carbon::parse($students->date_of_collection)->toString()); ?>
                            ...
                            <label class="block text-sm mb-4">
                                ...
                                <p
                                    class="block w-full mt-1 text-sm dark:border-gray-600 dark:bg-gray-700 focus:border-purple-400 focus:outline-none focus:shadow-outline-purple dark:text-gray-300 dark:focus:shadow-outline-gray form-input">
                                    <?php echo e(Str::upper($students->workdone_by)); ?>
                            ...
                            <label class="block text-sm mb-4">
                                ...
                                <p
                                    class="block w-full mt-1 text-sm dark:border-gray-600 dark:bg-gray-700 focus:border-purple-400 focus:outline-none focus:shadow-outline-purple dark:text-gray-300 dark:focus:shadow-outline-gray form-input">
                                    <?php echo e(Carbon\Carbon::parse($students->created_at)->diffForHumans()); ?>

                                </p>
                            </label>
                            <hr class="mt-8 mb-4">
                            <form action="/application/<?php echo e($students->id); ?>" method="post">
                                <?php echo csrf_field(); ?>
                                <?php echo method_field('PATCH'); ?>
        
                                <input type="hidden" name="pendinguser" value="<?php echo e($students->id); ?>">
                                <input type="hidden" name="userId" value="<?php echo e($students->id); ?>">
...
<?php echo $__env->make('master.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\Users\Micah\OneDrive\Desktop\FN\faan_admin\resources\views/backend/deviceApp.blade.php ENDPATH**/ ?>