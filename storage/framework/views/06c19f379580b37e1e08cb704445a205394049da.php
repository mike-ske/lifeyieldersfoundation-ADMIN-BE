<!DOCTYPE html>
<html lang="en" class="theme-dark" :class="{ 'theme-dark': dark }" x-data="data()" lang="<?php echo e(str_replace('_', '-', app()->getLocale())); ?>">
...
<head>
    ...
    <!-- Favicon icon -->
    <link rel="apple-touch-icon" sizes="180x180" href="<?php echo e(asset('image/favicon_io/apple-touch-icon.png')); ?>">
...
<?php /**PATH C:\Users\Micah\OneDrive\Desktop\FN\faan_admin\resources\views\layout\header.blade.php ENDPATH**/ ?>