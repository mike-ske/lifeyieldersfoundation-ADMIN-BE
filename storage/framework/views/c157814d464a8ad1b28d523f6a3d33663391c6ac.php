                ...
                <div class="w-full mb-10 sm:w-2/6 mr-10">
                    <div class="w-full mb-10 p-4 bg-white rounded-lg shadow-xs dark:bg-gray-800 mr-10" style="height: 222px">
                        <div class="relative w-full mr-3 rounded-full md:block">
                            ...
                            <a href="<?php echo e(URL('email/create')); ?>"
                            ...
                            <a href="<?php echo e(URL('email/')); ?>"
                                ...
                                <?php else: ?>
                                    <span class="ml-2" aria-hidden="true"><?php echo e($t); ?></span>
                                <?php endif; ?>
                            </a>
                            <a id="inbox"
                    ...
                    <div id="messagebox" class="hidden w-full mb-10 p-4 bg-white rounded-lg shadow-xs dark:bg-gray-800 mr-10"
                        ...
                        <div class="relative w-full mr-3 rounded-full md:block">
                            ...
                            <div class="mb-6">
                                <form action="<?php echo e(route('inbox')); ?>" method="POST" id="mailForm"
                        ...
                        <div class="w-full overflow-x-auto">
                            <table class="w-full whitespace-no-wrap">
                                <tbody class="bg-white divide-y dark:divide-gray-700 dark:bg-gray-800">
                                    <?php $__currentLoopData = $mail; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $mails): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                        <tr class="text-gray-700 dark:text-gray-400">
                                            <td class="px-4 py-3">
                                                <div class="flex items-center space-x-4 text-sm">
                                                    <button id="appbtn" type="button" value="<?php echo e($mails->id); ?>" data-modal-toggle="delete-mail" onclick="return mailDelete(this)" 
                                            ...
                                            <td class="px-4 py-3 overflow-hidden">
                                                <a href="email/<?php echo e($mails->id); ?>"
                                                    ...
                                                    <?php echo e(Illuminate\Support\Str::of($mails->mail_subject)->limit(50)); ?>

                                                </a>
                                            </td>
                                            <td class="px-4 py-3 text-sm">
                                                <?php echo e($mails->created_at->diffForHumans()); ?>
...
<?php echo $__env->make('master.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\Users\Micah\OneDrive\Desktop\FN\faan_admin\resources\views\pages\mails.blade.php ENDPATH**/ ?>