...
@section('contents')
        ...
        <div class="container px-6 mx-auto grid">
            ...
            <a
                ...
                <div class="flex items-center">
                    ...
                    <span>Here you can view all Grants Applicantion and send money to candidate.</span>
                </div>
            </a>
                                    ...
                                    <tr class="text-gray-700 dark:text-gray-400">
                                        <td class="px-4 py-3">
                                            <div class="flex items-center text-sm">
                                                ...
                                                @php
                                                    $image = DB::table('lyf_account')
                                                        ->where('id', $approveUser->user_id)
                                                        ->value('image');
                                                @endphp
                                                @if ($image === '')
                                                ...
                                                @endif
                                                <div>
                                                    <p class="font-semibold">{{ $approveUser->fname }}
                                                        {{ $approveUser->lname }}</p>
                                        ...
                                        <td class="px-4 py-3 text-xs">
                                            @php
                                                $granted = App\Models\Grant::where('lyf_account_id', $approveUser->user_id)->value('grant_status');
                                            @endphp
                                            @if ($granted == 0)
                                                <span
                                        ...
                                        <td class="px-4 py-3">
                                            <div class="flex items-center space-x-4 text-sm">
                                                <a href="grants/{{ $approveUser->user_id }}"
                                                ...
                                                <button id="appbtn" type="button" value="{{ $approveUser->user_id }}" data-modal-toggle="delete-grant-modal" onclick="return grantDelete(this)"
    ...
    <div class="hidden overflow-y-auto overflow-x-hidden fixed right-0 left-0 top-4 z-50 justify-center items-center md:inset-0 h-modal sm:h-full"
        id="delete-grant-modal" aria-hidden="true">
            ...
            <div class="relative bg-white rounded-lg shadow dark:bg-gray-700">
                ...
                <div class="flex justify-end p-2">
                    <button type="button"
                        ...
                        data-modal-toggle="delete-grant-modal">
                ...
                <div class="p-6 pt-0 text-center">
                    <form action="grants/delete" method="post" enctype="multipart/form-data">
                        @csrf
                        @method('DELETE')

                        <input type="hidden" name="id" id="grtId">
                        ...
                        <h3 class="mb-5 text-lg font-normal text-gray-500 dark:text-gray-400">
                            ...
                            delete
                            this APPLICANT ?</h3>
                        <button data-modal-toggle="delete-grant-modal" type="submit"
                        ...
                        <button data-modal-toggle="delete-grant-modal" type="button"
