        ...
        <div class="flex-1 h-auto max-w-4xl mx-auto overflow-hidden bg-white rounded-lg shadow-xl dark:bg-gray-800">
            <div class="w-full flex items-center justify-center m-0 p-6 sm:pl-12 sm:pr-12">
                <img aria-hidden="true" class="object-cover m-0 w-full h-full dark:block"
                    src="{{ asset('image/logo-compact2.jpg') }}" style="width: 100px" alt="Office" />
            </div>
                                    ...
                                    @foreach ($data as $devicedata)
                                        <div class="px-4 sm:w-full  rounded-lg shadow-md">
                                            ...
                                            <div class="w-full flex justify-between items-center">
                                                ...
                                                @if ($devicedata->workdone === 'Not yet fixed' || $devicedata->workdone === 'not yet fixed' )
                                                ...
                                                @endif
                                                @if ($devicedata->workdone === 'Pending')
                                                    <span style="font-size:10px"
                                                ...
                                                @endif
                                                @if ($devicedata->workdone === 'Fixed' || $devicedata->workdone   === 'fixed')
                                                    <span style="font-size:10px"
                                            ...
                                            <tr class="text-gray-700 dark:text-gray-400">
                                                ...
                                                <td class="px-4 py-3">
                                                    <p style="font-size: 11px"
                                                        ...
                                                        {{ Str::upper($devicedata->machine_model) }}
                                                    </p>
                                                </td>
                                            </tr>
                                            <tr class="text-gray-700 dark:text-gray-400">
                                            ...
                                            <tr class="text-gray-700 dark:text-gray-400">
                                                ...
                                                <td class="px-4 py-3">
                                                    <p style="font-size: 11px"
                                                        class="block w-full mt-1 text-sm dark:border-gray-600 dark:bg-gray-700 focus:border-purple-400 focus:outline-none focus:shadow-outline-purple dark:text-gray-300 dark:focus:shadow-outline-gray form-input">
                                                        {{ Str::upper($devicedata->nature_of_fault) }}
                                                    </p>
                                                </td>
                                            </tr>
                                            <tr class="text-gray-700 dark:text-gray-400">
                                                ...
                                                <td class="px-4 py-3">
                                                    <p style="font-size: 11px"
                                                        class="block w-full mt-1 text-sm dark:border-gray-600 dark:bg-gray-700 focus:border-purple-400 focus:outline-none focus:shadow-outline-purple dark:text-gray-300 dark:focus:shadow-outline-gray form-input">
                                                        {{ Str::upper($devicedata->department) }}
                                                    </p>
                                                </td>
                                            </tr>
                                            <tr class="text-gray-700 dark:text-gray-400">
                                                ...
                                                <td class="px-4 py-3">
                                                    <p style="font-size: 11px"
                                                        class="block w-full mt-1 text-sm dark:border-gray-600 dark:bg-gray-700 focus:border-purple-400 focus:outline-none focus:shadow-outline-purple dark:text-gray-300 dark:focus:shadow-outline-gray form-input">
                                                        {{ Carbon\Carbon::parse($devicedata->date_in)->toString() }}
                                                    </p>
                                                </td>
                                            </tr>
                                            <tr class="text-gray-700 dark:text-gray-400">
                                                ...
                                                <td class="px-4 py-3">
                                                    <p style="font-size: 11px"
                                                        class="block w-full mt-1 text-sm dark:border-gray-600 dark:bg-gray-700 focus:border-purple-400 focus:outline-none focus:shadow-outline-purple dark:text-gray-300 dark:focus:shadow-outline-gray form-input">
                                                        {{ Carbon\Carbon::parse($devicedata->date_of_collection)->toString() }}
                                                    </p>
                                                </td>
                                            </tr>
                                            <tr class="text-gray-700 dark:text-gray-400">
                                            ...
                                            <tr class="text-gray-700 dark:text-gray-400">
                                                ...
                                                <td class="px-4 py-3">
                                                    <p style="font-size: 11px"
                                                        class="block w-full mt-1 text-sm dark:border-gray-600 dark:bg-gray-700 focus:border-purple-400 focus:outline-none focus:shadow-outline-purple dark:text-gray-300 dark:focus:shadow-outline-gray form-input">
                                                        {{ Str::upper($devicedata->workdone_by) }}
                                                    </p>
                                                </td>
                                            </tr>
                                            <tr class="text-gray-700 dark:text-gray-400">
                                                ...
                                                <td class="px-4 py-3">
                                                    <p style="font-size: 11px"
                                                        class="block w-full mt-1 text-sm dark:border-gray-600 dark:bg-gray-700 focus:border-purple-400 focus:outline-none focus:shadow-outline-purple dark:text-gray-300 dark:focus:shadow-outline-gray form-input">
                                                        {{ Carbon\Carbon::parse($devicedata->created_at)->diffForHumans() }}
                                                    </p>
                                                </td>
                                            </tr>
                                </tbody>
