        ...
        <div class="container px-6 mx-auto grid">
            ...
            <a
                ...
                <div class="flex items-center">
                    ...
                    <span>Add and send nterview to candidates.</span>
                </div>
            </a>
                                    ...
                                    <tr class="text-gray-700 dark:text-gray-400">
                                        ...
                                        <td class="px-4 py-3">
                                            <div class="flex items-center space-x-4 text-sm">
                                                ...
                                                <a href="interview/{{ $approveUser->id }}"
                                                ...
                                                @php
                                                    ...
                                                    $role = App\Models\Role::find($role_id)->value('role');
                                                    
                                                @endphp
                                                @if ($role === 'admin')
                                                    <button id="appbtn" type="button" value="{{ $approveUser->id }}" onclick="return interviewDelete(this)"
                                                        class="flex items-center justify-between px-2 py-2 text-sm font-medium leading-5 text-purple-600 rounded-lg dark:text-gray-400 focus:outline-none focus:shadow-outline-gray"
                                                        aria-label="Delete">
                                                        <svg class="w-5 h-5" aria-hidden="true" fill="currentColor"
                                                            viewBox="0 0 20 20">
        ...
        <div class="relative px-4 w-full max-w-md h-full md:h-auto">
            ...
            <div class="relative bg-white rounded-lg shadow dark:bg-gray-700">
                ...
                <div class="p-6 pt-0 text-center">
                    <form id="form1" action="interview/delete" method="post" enctype="multipart/form-data">
                        @csrf
                        @method('DELETE')
