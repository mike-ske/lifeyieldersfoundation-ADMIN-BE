...
@section('contents')
        ...
        <div class="container px-6 mx-auto grid">
            ...
            <a
                ...
                <div class="flex items-center">
                    ...
                    <span>View all approved applications.</span>
                </div>
            </a>
                                        ...
                                        @if ($role === 'superadmin')
                                            <td class="px-4 py-3">
                                                <div class="flex items-center space-x-4 text-sm">
                                                    <button value="{{ $appValue->user_id }}" onclick="return approveDelete(this)" data-modal-toggle="delete-approve-modal"
    ...
    <div class="hidden overflow-y-auto overflow-x-hidden fixed right-0 left-0 top-4 z-50 justify-center items-center md:inset-0 h-modal sm:h-full"
        id="delete-approve-modal" aria-hidden="true">
            ...
            <div class="relative bg-white rounded-lg shadow dark:bg-gray-700">
                ...
                <div class="flex justify-end p-2">
                    <button type="button"
                        ...
                        data-modal-toggle="delete-approve-modal">
                ...
                <div class="p-6 pt-0 text-center">
                    <form action="approval/delete" method="post" enctype="multipart/form-data">
                        @csrf
                        @method('DELETE')
                        ...
                        <h3 class="mb-5 text-lg font-normal text-gray-500 dark:text-gray-400">
                            ...
                            delete
                            this APPLICANT ?</h3>
                        <button data-modal-toggle="delete-approve-modal" type="submit"
                        ...
                        <button data-modal-toggle="delete-approve-modal" type="button"
